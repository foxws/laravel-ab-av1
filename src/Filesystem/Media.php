...
class Media
{
    ...
    /**
     * Get a safe path for ab-av1 by creating a generic alias if configured.
    ...
    public function getSafeInputPath(): string
    {
        ...
        if (! Config::boolean('ab-av1.force_generic_input', false)) {
        ...
        // Copy or link the source to a generic name in the temp directory
